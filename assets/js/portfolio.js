class CaseStudyManager {
  constructor() {
    ...
    this.cards = this.grid
      ? Array.from(this.grid.querySelectorAll("[data-case-card]"))
      : [];
...
class PortfolioManager {
  constructor() {
    ...
    this.errorText =
      this.grid?.dataset.error || "Unable to load portfolio at the moment.";
    this.photoFallback =
      this.grid?.dataset.photoFallback || "Photo by Enes Türkoğlu";
      ...
      const mockPhotos = [
        {
          ...
          src: {
            large:
              "https://images.pexels.com/photos/33917696/pexels-photo-33917696.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
            large2x:
              "https://images.pexels.com/photos/33917696/pexels-photo-33917696.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
          },
        ...
        },
        {
          ...
          src: {
            large:
              "https://images.pexels.com/photos/34032055/pexels-photo-34032055.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
            large2x:
              "https://images.pexels.com/photos/34032055/pexels-photo-34032055.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
          },
        ...
        },
        {
          ...
          src: {
            large:
              "https://images.pexels.com/photos/34032094/pexels-photo-34032094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
            large2x:
              "https://images.pexels.com/photos/34032094/pexels-photo-34032094.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
          },
        ...
        },
        {
          ...
          src: {
            large:
              "https://images.pexels.com/photos/34032113/pexels-photo-34032113.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
            large2x:
              "https://images.pexels.com/photos/34032113/pexels-photo-34032113.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
          },
